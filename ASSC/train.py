...
def get_model():
	model = Sequential()
	model.add(Conv2D(60, (1,25), activation='relu', input_shape=(3,3000,1),padding='same'))
...
def main():
	...
	for i in range(len(train_data)):
		...
		imfs0, imfs1 = EMD_anly(train_data[i])
		train_x.append([train_data[i],d,w,imfs0,imfs1])
		'''
		plt.subplot(5,1,1)
	...
	np.save('x_train_new.npy', train_x)
	np.save('y_train_new.npy', train_y)
